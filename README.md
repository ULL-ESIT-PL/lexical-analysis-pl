See the ULL OCW course [PROCESADORES DE LENGUAJES](https://campusvirtual.ull.es/ocw/course/view.php?id=45#section-0) the sections
...
* Folder [lex-lox](https://github.com/ULL-ESIT-PL/ocw-pl/tree/main/lex-lox) contains the [lexical analyzer of the lox interpreter](https://craftinginterpreters.com/scanning-on-demand.html#the-scanner-scans) from the book [Crafting Interpreters](https://craftinginterpreters.com/). 
